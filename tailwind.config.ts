  ...
  theme: {
    extend: {
      colors: {
        ...
        "general-colorsprimary": "var(--general-colorsprimary)",
        "gray-0": "var(--gray-0)",
        "gray-1": "var(--gray-1)",
      ...
      fontFamily: {
        ...
        "menu-l-poppins-m": "var(--menu-l-poppins-m-font-family)",
        "sub-heading": "var(--sub-heading-font-family)",
        "sub-heading-2": "var(--sub-heading-2-font-family)",
        "text-single-200-bold": "var(--text-single-200-bold-font-family)",
        sans: [
          "ui-sans-serif",
          "system-ui",
          "sans-serif",
